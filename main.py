...
if m=="1":
    ...
    Player_names=["master1","master2","master3","GPT"] # 4元 列表，对应四个玩家名字，不填默认["player1","player2","player3","player4"]，(如果不全剩下的默认，如果超出选择前四个)
    ...
    Rules={"放炮":True, "碰": False, "吃":False}#字典，规则设定，默认全部False（这样比较难和牌）,吃规则还没编
